...
export default function DashPosts() {
  ...
  const [postIdToDelete, setPostIdToDelete] = useState(''); // <-- fixed setter name here
                ...
                <TableRow className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <TableCell>
                    <span
                      onClick={() => {
                        setShowModal(true);
                        setPostIdToDelete(post._id); // using correct setter here
                      }}
        ...
        <ModalBody>
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button onClick={handleDeletePost} color="failure" className="bg-red-600 hover:bg-red-700 text-white font-semibold">
                Yes, I'm sure
              </Button>
